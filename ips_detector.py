...
def send_email(subject, body):
    with smtplib.SMTP_SSL("smtp.gmail.com", 465) as server:
        server.login("arman.aleksanyan.a02@gmail.com", "sjcapygfohxndody")
        server.sendmail("arman.aleksanyan.a02@gmail.com", "arman.aleqsanyan.a02@gmail.com", f'Subject: {subject}\n\n{body}')
...
if __name__ == '__main__':
    sniff(prn=detect_scan, filter='ip and tcp', store=0)
